package com.example.lenovo.myapplication.dao;
...
import com.example.lenovo.myapplication.Bean;
...
public class BeanDao extends AbstractDao<Bean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Paw = new Property(2, String.class, "paw", false, "PAW");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Bean entity) {
        ...
        String paw = entity.getPaw();
        if (paw != null) {
            stmt.bindString(3, paw);
        }
    }
    ...
    public Bean readEntity(Cursor cursor, int offset) {
        Bean entity = new Bean( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // paw
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Bean entity, int offset) {
        ...
        entity.setPaw(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
